...
DatabaseReference reference;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       //actionBar.setSubtitle(email);
        ...
        description=findViewById(R.id.PostContent);
        ...
        uploadBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(image_uri==null){
                    uploadData(titleText,des,"noImage");

                }else{

                }
                uploadData(titleText,des,String.valueOf(image_uri));
    ...
    private void uploadData(String titleText, String des, String uri) {
